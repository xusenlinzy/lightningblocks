...
task_name = "cmeee-bert-global-pointer"  # 自定义任务名称

# model hyperparameters
downstream_model_name = "global-pointer"  # 模型名称
...
output_dir = "outputs/cmeee/global-pointer"  # 模型保存路径
