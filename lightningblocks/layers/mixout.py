...
class MixLinear(torch.nn.Module):
    ...
    # If you want to change a dropout layers to a mixout layers,
    ...
    def extra_repr(self):  # sourcery skip: avoid-builtin-shadow
        type = "drop" if self.target is None else "mix"
        return f"{type}out={self.p}, in_features={self.in_features}, out_features={self.out_features}, bias={self.bias is not None}"
