...
def get_idx_from_word(word, word_to_idx, unk_word):
    return word_to_idx[word] if word in word_to_idx else word_to_idx[unk_word]
...
class JiebaTokenizer(BaseTokenizer):
    ...
    Args:
        vocab(lightningblocks.data.Vocab): An instance of :class:`lightningblocks.data.Vocab`.
    """
    ...
    def cut(self, sentence, cut_all=False, use_hmm=True):
        ...
        Example:
            .. code-block:: python
                from lightningblocks.data import Vocab, JiebaTokenizer
