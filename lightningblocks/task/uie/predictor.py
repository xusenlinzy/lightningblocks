...
from lightningblocks.utils.common import cut_chinese_sent, dbc2sbc
from lightningblocks.task.uie.utils import get_bool_ids_greater_than, get_span, get_id_and_prob
...
class PyTorchInferBackend:
    def __init__(self, model_name_or_path, device='cpu', use_fp16=False, multilingual=False):
        from lightningblocks.task.uie.model import UIE, UIEM
