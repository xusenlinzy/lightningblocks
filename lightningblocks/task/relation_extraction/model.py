...
from lightningblocks.task.relation_extraction.auto import get_auto_re_model, get_auto_re_model_config
from lightningblocks.task.relation_extraction.auto import RelationExtractionPipeline
...
class RelationExtractionTransformer(TaskTransformer):
    ...
    Args:
        *args:
            :class:`lightningblocks.core.model.TaskTransformer` arguments.
