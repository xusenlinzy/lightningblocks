...
from lightningblocks.metrics import ExtractionScore
from lightningblocks.task.named_entity_recognition.auto import get_auto_ner_model, get_auto_ner_model_config
from lightningblocks.task.named_entity_recognition.auto import NerPipeline


class NamedEntityRecognitionTransformer(TaskTransformer):
    """Defines ``LightningModule`` for the Token Classification Task.
    Args:
        *args: :class:`lightningblocks.core.model.TaskTransformer` arguments.
        downstream_model_type: Downstream Model to load.
        **kwargs: :class:`lightningblocks.core.model.TaskTransformer` arguments.
    """
